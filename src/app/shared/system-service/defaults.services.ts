...
export class DefaultService implements BaseService{
    ...
    private buildDefaultSettingsMap(): Map<string, string> {
        return new Map<string, string>([
            ...
            [Constants.ENVIRONMENT, Constants.ENVIRONMENT_VALUE],
            [Constants.DEFAULT_SHOW_HIDDEN_FILES_AND_FOLDERS, Constants.DEFAULT_SHOW_HIDDEN_FILES_AND_FOLDERS_VALUE],
            [Constants.DEFAULT_SHOW_FILE_EXTENSIONS, Constants.DEFAULT_SHOW_FILE_EXTENSIONS_VALUE],
            [Constants.DEFAULT_DISPLAY_FULL_PATH_IN_TITLE_BAR, Constants.DEFAULT_DISPLAY_FULL_PATH_IN_TITLE_BAR_VALUE],
            [Constants.DEFAULT_OPEN_FILE_EXPLORER_TO, Constants.DEFAULT_OPEN_FILE_EXPLORER_TO_VALUE],
            [Constants.DEFAULT_OPEN_FOLDER_IN_SAME_WINDOW, Constants.DEFAULT_OPEN_FOLDER_IN_SAME_WINDOW_VALUE],
            [Constants.DEFAULT_SHOW_RECENTLY_USED_FILES, Constants.DEFAULT_SHOW_RECENTLY_USED_FILES_VALUE],
            [Constants.DEFAULT_SHOW_FREQUENTLY_USED_FOLDERS, Constants.DEFAULT_SHOW_FREQUENTLY_USED_FOLDERS_VALUE]
        ]);
    }
