...
import { ChatMessage } from 'src/app/applications/system-apps/chatter/model/chat.message';
import { IUserData } from 'src/app/applications/system-apps/chatter/model/chat.interfaces';
import { ProcessIDService } from '../shared/system-service/process.id.service';
